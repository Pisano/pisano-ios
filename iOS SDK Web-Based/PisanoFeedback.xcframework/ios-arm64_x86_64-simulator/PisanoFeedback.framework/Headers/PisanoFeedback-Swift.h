...
/// The SDK Health Check is succesful
  CloseStatusHealthCheckSuccessful = 10,
/// The SDK Health Check is failed
  CloseStatusHealthCheckFailed = 11,
/// Survey won’t be shown due to passive survey
  CloseStatusSurveyPassive = 12,
};

@class NSString;
SWIFT_CLASS("_TtC14PisanoFeedback17CloseStatusHelper")
...
/// Pisano Health Check
+ (void)healthCheckWithFlowId:(NSString * _Nullable)flowId language:(NSString * _Nullable)language customer:(NSDictionary<NSString *, id> * _Nullable)customer payload:(NSDictionary<NSString *, NSString *> * _Nullable)payload completion:(void (^ _Nonnull)(BOOL))completion;
/// <ul>
///   <li>
///     Pisano Show
///   </li>
