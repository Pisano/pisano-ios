...
#ifndef PISANOFEEDBACK_SWIFT_H
#define PISANOFEEDBACK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PisanoFeedback",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP14PisanoFeedback14FontProperties_")
...
SWIFT_CLASS("_TtC14PisanoFeedback11BasicStyles")
...
typedef SWIFT_ENUM(NSInteger, FeedbackCallback, open) {
  FeedbackCallbackUnknown = -1,
  FeedbackCallbackClosed = 0,
  FeedbackCallbackSuccess = 1,
  FeedbackCallbackSendFeedback = 2,
  FeedbackCallbackInvalidCredentials = 3,
  FeedbackCallbackInvalidApiUrl = 4,
  FeedbackCallbackInvalidEventUrl = 5,
  FeedbackCallbackNetworkError = 6,
  FeedbackCallbackMultipleFeedback = 7,
  FeedbackCallbackDisplayOnce = 8,
  FeedbackCallbackChannelQuota = 9,
};
...
SWIFT_PROTOCOL("_TtP14PisanoFeedback14LineProperties_")
...
SWIFT_CLASS("_TtC14PisanoFeedback10LineStyles")
...
SWIFT_CLASS("_TtC14PisanoFeedback10LinkStyles")
...
SWIFT_CLASS("_TtC14PisanoFeedback14SwiftyMarkdown")
